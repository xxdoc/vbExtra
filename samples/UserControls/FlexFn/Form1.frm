...
Begin VB.Form Form1 
   ...
   Begin vbExtra.FlexFn FlexFn1 
      ...
      ShowToolTipsForOrderColumns=   0   'False
      AllowTextEdition=   0   'False
   ...
   Begin VB.Label Label1 
      Caption         =   "Note: all the code in this form is to fill the grid and display the data, the FlexFn control has no code."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9
         Charset         =   0
...
Private Sub LoadSampleData()
    ...
    For c = 0 To UBound(iLines)
        If Trim$(iLines(c)) <> "" Then
            iRows = ChrCount(iLines(c), AscW(vbTab)) + 1
            If iRows > MSFlexGrid1.Cols Then
                MSFlexGrid1.Cols = iRows
            End If
