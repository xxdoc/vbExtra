VERSION 5.00
Begin VB.UserControl ButtonExNoFocus 
   AutoRedraw      =   -1  'True
   CanGetFocus     =   0   'False
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   PropertyPages   =   "ctlButtonExNoFocus.ctx":0000
   ScaleHeight     =   300
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   400
   ToolboxBitmap   =   "ctlButtonExNoFocus.ctx":0035
End
Attribute VB_Name = "ButtonExNoFocus"
...
Private m_ShowToolTipTextWhenDisabled As Boolean
...
Private Sub DrawWinXPButton(ByVal vState As enumButtonStates)
    ...
    Select Case vState
        ...
        Case eStateDown
            ...
            DrawLineApi 2, 2, 2, lh - 2, ShiftColor(bColor, -0.1)   'Left 1 Line
...
Private Sub UserControl_AccessKeyPress(KeyAscii As Integer)
    ...
    If m_ShowToolTipTextWhenDisabled Then If Not m_bEnabled Then Exit Sub
...
Private Sub UserControl_InitProperties()
    ...
    m_ShowToolTipTextWhenDisabled = False
    ...
    UserControl.Size 1500, 375
End Sub

Private Sub UserControl_KeyDown(KeyCode As Integer, Shift As Integer)

    If m_ShowToolTipTextWhenDisabled Then
        If Not m_bEnabled Then
            KeyCode = 0
            Exit Sub
        End If
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        m_ShowToolTipTextWhenDisabled = .ReadProperty("ShowToolTipTextWhenDisabled", False)

        UserControl.ForeColor = m_bColors.tForeColor
        If Not m_ShowToolTipTextWhenDisabled Then
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        .WriteProperty "ShowToolTipTextWhenDisabled", m_ShowToolTipTextWhenDisabled, False
...
Public Property Let ShowToolTipTextWhenDisabled(nValue As Boolean)
    If nValue <> m_ShowToolTipTextWhenDisabled Then
        m_ShowToolTipTextWhenDisabled = nValue
        If m_ShowToolTipTextWhenDisabled Then
...
Public Property Get ShowToolTipTextWhenDisabled() As Boolean
    ShowToolTipTextWhenDisabled = m_ShowToolTipTextWhenDisabled
End Property
